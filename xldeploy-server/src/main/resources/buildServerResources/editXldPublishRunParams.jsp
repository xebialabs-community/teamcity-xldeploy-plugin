...
<l:settingsGroup title="XL Deploy:Publish">
  ...
  <tr id="xldpublishclipath">
    <th><label for="${constants.xldPublishCliPath}">XL Deploy CLI path: <l:star/></label></th>
    <td><props:textProperty name="${constants.xldPublishCliPath}" className="longField"/>
      <span class="error" id="error_${constants.xldPublishCliPath}"></span>
      <span class="smallNote">Path to XL Deploy CLI executable (cli.sh or cli.cmd))</span>
    </td>
  </tr>

  <tr id="xldpublishhost">
    <th><label for="${constants.xldPublishHost}">XL Deploy host: </label></th>
  ...
  <tr id="xldpublishport">
    <th><label for="${constants.xldPublishPort}">XL Deploy port: </label></th>
