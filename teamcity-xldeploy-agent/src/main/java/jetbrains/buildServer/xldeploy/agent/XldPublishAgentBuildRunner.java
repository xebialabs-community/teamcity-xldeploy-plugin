...
import jetbrains.buildServer.xldeploy.agent.XldPublishBuildProcess;

import org.jetbrains.annotations.NotNull;

public class XldPublishAgentBuildRunner implements AgentBuildRunner, AgentBuildRunnerInfo {
  ...
  public BuildProcess createBuildProcess (@NotNull AgentRunningBuild runningBuild, @NotNull BuildRunnerContext context) throws RunBuildException {
    XldPublishBuildProcess bp = new XldPublishBuildProcess(runningBuild, context);
    return bp;
  }
